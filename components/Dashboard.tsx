...
const Dashboard = () => {
  const timelineData: Record<User, TimelineEvent[]> = {
    'Paciente': [
      { id: 1, action: 'recostado en cama', startTime: '08:00', endTime: '10:00' },
      { id: 2, action: 'caminando', startTime: '10:00', endTime: '10:30' },
      { id: 3, action: 'sentado', startTime: '10:30', endTime: '12:00' },
      { id: 4, action: 'recostado en el suelo', startTime: '12:00', endTime: '12:30' },
      { id: 5, action: 'parado', startTime: '12:30', endTime: '13:00' },
      { id: 6, action: 'ausente en camara', startTime: '13:00', endTime: '14:00' },
    ],
    'Personal Médico': [
      { id: 1, action: 'presente', startTime: '09:00', endTime: '11:00' },
      { id: 2, action: 'presente', startTime: '14:00', endTime: '16:00' },
    ],
    'Visitas': [
      { id: 1, action: 'presente', startTime: '11:00', endTime: '12:00' },
      { id: 2, action: 'presente', startTime: '15:00', endTime: '16:00' },
    ],
  };
